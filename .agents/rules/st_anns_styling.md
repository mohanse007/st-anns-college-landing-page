...
- Always use the premium glassmorphism/galaxy-blur style:
  ...
  - Borders: `border border-white/30`
...
- Hover sub-links inside the dropdown should use matching transparent backgrounds and bold text:
  - Standard styling: `block px-4 py-2 text-xs text-gray-800 hover:text-purple-700 hover:bg-white/20 font-bold transition-colors whitespace-nowrap text-center`
