              ...
              >
                ...
                {link.dropdown && activeDropdown === link.name && (
                  <motion.div
                    ...
                    className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-56 bg-white/80 backdrop-blur-xl rounded-xl shadow-xl border border-white/20 py-2 z-50"
                  >
                    {link.dropdown.map((sub) => (
                      <a
                        ...
                        className="block px-4 py-2 text-xs text-gray-600 hover:text-purple-600 hover:bg-purple-50/50 font-medium transition-colors whitespace-nowrap text-center"
                      >
                        {sub.name}
                      </a>
                    ))}
